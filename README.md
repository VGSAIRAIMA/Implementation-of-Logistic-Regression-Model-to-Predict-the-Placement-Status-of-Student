...
## Algorithm
1. Import the required libraries and create the dataset for student placement details.
...
4. Predict the placement status for test data and evaluate the model accuracy.
...
## Output:
![image](https://github.com/VGSAIRAIMA/Implementation-of-Logistic-Regression-Model-to-Predict-the-Placement-Status-of-Student/blob/main/Screenshot%202026-05-21%20202621.png)
